...
![VScodeのダウンロード画面](https://drive.google.com/file/d/1ftMD-Kd7t6T8Y4XZ_HyFDbty9u0-d8cw/view?usp=sharing "VScodeのダウンロード画面")  
...
### 日本語化の手順  
![VScode拡張機能](https://drive.google.com/file/d/1Lr4CDkusT-TtXB7GrXRxPDPDEIWmBWmC/view?usp=sharing "VScode拡張機能")    
